...
### Structural note for the view-layer restructure — the web has ONE image path, Swift/Python have TWO
...
with the view-layer restructure, not here** (user, 2026-07-16).
...
### O. Date format: Python `, ` vs Swift/web ` at ` — ROOT-CAUSED 2026-07-18 (the date-format item)
...
- **`Generated by GuitarTap Web 1.0.2 (112)`** vs `GuitarTap 1.0.2 (398/440)` — the edition name is
  intentional.
- **fL/thickness value differences** (66.9 vs 67.0; 2.81 vs 2.80) — the buffer-size item's first-tap defect,
  not a PDF issue.
