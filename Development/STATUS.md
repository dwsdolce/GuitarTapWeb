...
| 11 | **Material measurement dimensions — override, display, sourcing (+ notes-on-load)** | 🚧 Web A+B+naming done (`30dff21`, `b490c0a`, `228c24b`; toggle rename cross-platform Swift `2233479`/Python `ead835c`); remaining: PDF, notes-on-load, §12 type-res, tests. Swift + Python done through Chunk D. | [MEASUREMENT-DIMENSIONS-SPEC.md](MEASUREMENT-DIMENSIONS-SPEC.md) §10 |
