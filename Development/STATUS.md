...
| 10 | **Peak lifecycle — durability of per-peak state** | 🟡 In progress. Swift Phases 0–5 + the reset-to-auto-label fix done and user-verified (Phase 5 batch uncommitted); **next = Phase 6**. Ports (Python, then web) are Phase 9 and gated on Phase 8. | [PEAK-LIFECYCLE-PLAN-SWIFT.md](PEAK-LIFECYCLE-PLAN-SWIFT.md) |
