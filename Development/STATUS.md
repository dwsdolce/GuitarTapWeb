...
| 4 | **Platform parity gaps** (Swift/Python/web behavior + UI) | Backlog — 4 gaps (OUT-1/2/3 from the 6-3c review; **OUT-4** material tap-detection model — relative noise-floor EMA vs absolute dBFS — added during 6-TEST 4b); a **separate cross-platform effort, after Phase 6**. Not started. | [PLATFORM-PARITY-GAPS.md](PLATFORM-PARITY-GAPS.md) |
