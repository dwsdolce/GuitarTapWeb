...
| 10 | **Peak lifecycle — durability of per-peak state** | 🟡 In progress. Swift Phases 0–4 done and user-verified (Phase 4 uncommitted); **next = Phase 4a**. Ports (Python, then web) are Phase 9 and gated on Phase 8. | [PEAK-LIFECYCLE-PLAN-SWIFT.md](PEAK-LIFECYCLE-PLAN-SWIFT.md) |
