...
| 11 | **Material measurement dimensions — override, display, sourcing (+ notes-on-load)** | 🚧 Web: only Chunk-D user-facing docs (held) remain; §12 immune (no code change). Swift + Python complete. | [MEASUREMENT-DIMENSIONS-SPEC.md](MEASUREMENT-DIMENSIONS-SPEC.md) §10 |
