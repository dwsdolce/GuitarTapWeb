...
| 10 | **Peak lifecycle — durability of per-peak state** | 🟡 In progress. Swift Phases 0–6 done (0–5 committed + verified; **Phase 6 core user-verified + Phase 6b code-written, both UNCOMMITTED, 6b not yet run-reviewed**); **next = Phase 7**. Ports (Python, then web) are Phase 9 and gated on Phase 8. | [PEAK-LIFECYCLE-PLAN-SWIFT.md](PEAK-LIFECYCLE-PLAN-SWIFT.md) |
