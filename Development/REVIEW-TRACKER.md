...
| `view/guitar-summary` (UNREVIEWED) | — | — | 0 | — | the last view slug (M4): web `AnalysisResults.tsx` + Swift/Python guitar-summary sections — get docs during its own full review |
