...
// Reference values from the canonical Python material_properties (plate beam
// constant βL² = 22.37). Mirrors Swift PlatePropertiesTests.
const plate: Dimensions = { lengthMm: 560, widthMm: 230, thicknessMm: 2.8, massG: 210 }
const fL = 67.11537
const fC = 116.27016
const fLC = 35.35375

describe('G4b — plate material property formulas', () => {
