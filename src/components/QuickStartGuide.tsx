  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        title: 'Measurements',
        icon: 'clipboard',
        body: "Lists all saved measurements. Double-click a row to load the measurement into the main view — the measurements window closes automatically after loading. Click a row's ⋯ button or right-click it to access: Load into View, View Details, Edit Name & Notes, Export Measurement (saves the .guitartap file), Export Spectrum (saves the chart image), Export PDF Report, or Delete. Use Import Measurement to load a .guitartap file from disk or another device. Use Compare to enter multi-select mode and overlay 2–5 saved guitar measurements on the main chart for side-by-side comparison. The measurement name and notes can also be edited from the Edit button in the Measurement Details dialog.",
      },
      {
