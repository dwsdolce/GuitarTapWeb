  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        title: 'Measurements',
        icon: 'clipboard',
        body: "Lists all saved measurements. Double-click a row to load the measurement into the main view — the measurements window closes automatically after loading. Click a row's ⋯ button or right-click it to access: Load into View, View Details, Edit Name & Notes, Export Measurement (saves the .guitartap file), Export Spectrum (saves the chart image), Export PDF Report, or Delete. Use Import Measurement to load a .guitartap file from disk or another device. Use Export All to save your whole library to a single .guitartap file — for backing it up or moving the complete set of measurements to another platform or another browser. This backup matters on the web because the browser can clear the library — in Safari it is deleted after about 7 days without visiting the site (on macOS and iOS alike); installing the app (Add to Home Screen / Add to Dock) makes storage durable, and an Export All file is the portable backup. Re-import it with Import Measurement. Use Compare to enter multi-select mode and overlay 2–5 saved guitar measurements on the main chart for side-by-side comparison. The measurement name and notes can also be edited from the Edit button in the Measurement Details dialog.",
      },
      {
